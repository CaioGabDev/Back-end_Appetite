...
('Biscoito de Polvilho', 'Biscoito brasileiro crocante e sem glúten, feito com polvilho. Perfeito para acompanhar café.', 'Polvilho doce, polvilho azedo, ovos, óleo, queijo ralado', 'Misture os polvilhos com ovos batidos, óleo quente e queijo. Amasse bem até formar uma massa lisa. Modele biscoitinhos pequenos e asse em forno pré-aquecido até dourar e ficar crocante.', 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400', FALSE, 4, 35, 'FACIL', 1);

-- Atualizando receitas com URLs de imagens
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=400' WHERE titulo = 'Bolo de Cenoura';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=400' WHERE titulo = 'Pudim de Leite';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400' WHERE titulo = 'Brigadeiro';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1621996346565-e3dbc353d2e5?w=400' WHERE titulo = 'Macarrão à Carbonara';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1574894709920-11b28e7367e3?w=400' WHERE titulo = 'Lasanha à Bolonhesa';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1572441713132-51c75654db73?w=400' WHERE titulo = 'Nhoque de Batata';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1432139555190-58524dae6a55?w=400' WHERE titulo = 'Bife à Parmegiana';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1598103442097-8b74394b95c6?w=400' WHERE titulo = 'Frango Assado';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1544025162-d76694265947?w=400' WHERE titulo = 'Feijoada';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1512852939750-1305098529bf?w=400' WHERE titulo = 'Salada Caesar';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1603133872878-684f208fb84b?w=400' WHERE titulo = 'Quiche de Legumes';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400' WHERE titulo = 'Hambúrguer Artesanal';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1541745537411-b8046dc6d66c?w=400' WHERE titulo = 'Coxinha';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1627662168223-7df99068099a?w=400' WHERE titulo = 'Pastel de Carne';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1622597467836-f3285f2131b8?w=400' WHERE titulo = 'Suco Detox';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1553909489-cd47e0ef937f?w=400' WHERE titulo = 'Vitamina de Banana';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=400' WHERE titulo = 'Caldo Verde';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1547592180-85f173990554?w=400' WHERE titulo = 'Sopa de Legumes';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1534080564583-6be75777b70a?w=400' WHERE titulo = 'Paella de Frutos do Mar';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1476124369491-e7addf5db371?w=400' WHERE titulo = 'Risoto de Camarão';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1565299507177-b0ac66763828?w=400' WHERE titulo = 'Strogonoff de Carne';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1574894709920-11b28e7367e3?w=400' WHERE titulo = 'Escondidinho de Carne Seca';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1565958011703-44f9829ba187?w=400' WHERE titulo = 'Moqueca de Peixe';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1565958011703-44f9829ba187?w=400' WHERE titulo = 'Bobó de Camarão';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1541781774459-bb2af2f05b55?w=400' WHERE titulo = 'Mousse de Chocolate';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1565958011703-44f9829ba187?w=400' WHERE titulo = 'Torta de Limão';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1497034825429-c343d7c6a68f?w=400' WHERE titulo = 'Sorvete de Morango';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1571115764595-644a1f56a55c?w=400' WHERE titulo = 'Pavê de Chocolate';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1565958011703-44f9829ba187?w=400' WHERE titulo = 'Banoffee Pie';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?w=400' WHERE titulo = 'Açaí na Tigela';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1551538827-9c037cb4f32a?w=400' WHERE titulo = 'Caipirinha';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1610970881699-44a5587cabec?w=400' WHERE titulo = 'Smoothie Verde';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1551024506-0bccd828d307?w=400' WHERE titulo = 'Mojito';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=400' WHERE titulo = 'Canja de Galinha';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1547592180-85f173990554?w=400' WHERE titulo = 'Sopa de Abóbora';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=400' WHERE titulo = 'Caldinho de Feijão';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1547592180-85f173990554?w=400' WHERE titulo = 'Gazpacho';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1627662168223-7df99068099a?w=400' WHERE titulo = 'Tapioca Doce';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1574894709920-11b28e7367e3?w=400' WHERE titulo = 'Empadão de Frango';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1541745537411-b8046dc6d66c?w=400' WHERE titulo = 'Esfirra de Carne';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1541745537411-b8046dc6d66c?w=400' WHERE titulo = 'Quibe Frito';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1565299507177-b0ac66763828?w=400' WHERE titulo = 'Wrap de Frango';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1461023058943-07fcbe16d735?w=400' WHERE titulo = 'Café Gelado';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1556679343-c7306c1976bc?w=400' WHERE titulo = 'Chá Gelado de Frutas';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1553909489-cd47e0ef937f?w=400' WHERE titulo = 'Vitamina de Abacate';
UPDATE receitas SET imagem = 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400' WHERE titulo = 'Biscoito de Polvilho';
